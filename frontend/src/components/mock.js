...
export const mockData = {
  ...
  services: [
    {
      id: 1,
      title: "Cinematic Reels Production",
      description: "Epic storytelling through cinematic visuals that captivate and inspire your audience.",
      icon: "Film",
    ...
    },
    {
      ...
      description: "Transform your special moments into unforgettable highlight reels.",
      icon: "Camera",
      features: ["Multi-angle Coverage", "Same-day Delivery", "Custom Music", "Social Media Ready"]
    },
    {
      id: 3,
      title: "Talking-Head Edits",
      description: "Professional talking-head videos that build trust and establish authority.",
      icon: "Video",
      features: ["Professional Editing", "Brand Integration", "Caption Creation", "Platform Optimization"]
    },
    {
      id: 4,
      title: "Short-Form Social Content",
      description: "Viral-ready content optimized for Instagram, TikTok, and YouTube Shorts.",
      icon: "Smartphone",
      features: ["Trending Formats", "Quick Turnaround", "Platform Specific", "Engagement Optimization"]
    }
  ],
  ...
  portfolio: {
    categories: ["All", "Cinematic Reels", "Event Highlights", "Talking-Head Videos"],
    projects: [
      {
        id: 1,
        title: "Epic Cinematic Reel",
  ...
  contact: {
    info: {
      phone: "+91 9406586610",
      email: "sy958920@gmail.com",
      instagram: "@suryansh_yadav27",
      linkedin: "suryansh-yadav"
    },
    whatsapp: {
      number: "+919406586610",
